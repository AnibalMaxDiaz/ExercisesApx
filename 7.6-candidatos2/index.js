...
for (const index in candidatos) {
  const indice = parseInt(candidatos[index]);
  console.log(usuarios[indice]); // ya tenemos el indice "index" solo es cuestion de especificarlo en el array "usuarios" para no tener que iterar de nuevo como muestro en las siguientes lineas comentadas!
