...
for (const v of videos) {
  ...
  // [tu lógica acá]
  // iteramos cada objeto del array de videos y accedemos a su id con videos[id] luego buscamos videos[id] como clave en el objeto vistosById y mostramos los que no se han visto con el simbolo de negacion !
  if (!vistosById[v.id]) {
    // Mostramos el video que no ha sido visto
    console.log(v);
  }
  // console.log("===========================================================");
  // console.log(Object.keys(vistosById));
  // console.log("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
